...
export default function Home() {
  ...
  return (
    <div className="flex flex-col h-screen items-center justify-start bg-gradient-to-r from-blue-500 to-purple-600 p-8 overflow-auto">
      ...
      <div class="bg-white/10 rounded-lg p-4 w-full max-w-4xl">
        <h2 class="text-xl font-bold text-white mb-2">合併任務（Boost.space + Aitable）</h2>
        <pre class="text-white text-xs max-h-48 overflow-auto">{JSON.stringify(mergedTasks, null, 2)}</pre>
      </div>
